...
| Ingestion | Design-ready | Implemented (247 ingestion + 466 common tests; losslessness + 1800 s soak proven) | Tested-in-sandbox (10,716 rows fake→Fluss, 49k tps synthetic envelope, `full-audit` C6 `466/247/386`) | Blocked |
