...
### FACT-011: Fluss tiers closed segments to R2 and commits the manifest; clients read them back from R2, but R2 is not a tablet restore source (measured on 0.9.1; 1.0.0 re-verification OUTSTANDING)
Status: LIVE
...
Recheck when: Fluss image bump, or a change to remote.data.dir (the image bump to 1.0.0 HAS fired - see the 2026-09-22 line)
